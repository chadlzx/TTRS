...
bool query_ticket(String<40> Loc1,String<40> Loc2,String<12> Data,String<10> Catalog){
	Bptree<String<40>,String<20> >::iterator it=Train_Index.find(Loc1);
	int sum=0;
	ticket t[100];
...
bool query_transfer(String<40> loc1,String<40> loc2,String<12> data,String<10> catalog)
{
	...
	Bptree<String<40>,String<20> >::iterator it1=Train_Index.find(loc1);
	...
	while((*it1).first==loc1&&it1!=Train_Index.end()){
		...
		Bptree<String<40>,String<20> >::iterator it2=Train_Index.find(loc2);
...
bool query_order(int id,String<12> data,String<10> catalog){
	...
	Bptree<KEY2,ticket>::iterator it=TICKET.find(KEY2(id,data));
	int sum=0;
...
String<40> loc2,String<12> data,String<40> ticket_kind)
{
	...
	Bptree<KEY2,ticket>::iterator it=TICKET.find(key);
