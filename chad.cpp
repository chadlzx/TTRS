...
Bptree<int,user,4096/sizeof(user),3> USER("user");//用户数据库
...
Bptree<String<20>,train,4096/sizeof(train),3> TRAIN("train");//根据train_id排序

Bptree<String<40>,String<20>,4096/sizeof(String<20>),3 >  Train_Index("train_index");
...
Bptree<KEY2,ticket,4096/sizeof(ticket),3> TICKET("ticket");
...

{
	...
	Bptree<KEY2,ticket,4096/sizeof(ticket),3>::iterator it;
